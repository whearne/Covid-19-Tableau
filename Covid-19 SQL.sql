...
--Select location, date, population, reproduction_rate
--From PortfolioProject..CovidDeaths
--where reproduction_rate is not null
--	and location like '%Kingdom'
--order by 1,2 asc

--Select location, population, Max(total_tests_per_thousand) as total_tests_per_thousand, human_development_index
--From PortfolioProject..CovidVaccinations
--where human_development_index is not null
--	and total_tests_per_thousand is not null
...
Select location, population, Max(cast(people_fully_vaccinated as bigint)) as people_fully_vaccinated, (Max(cast(people_fully_vaccinated as bigint))/population)*100 as percentage_population_vaccinated
--From PortfolioProject..CovidDeaths
From PortfolioProject..CovidVaccinations
